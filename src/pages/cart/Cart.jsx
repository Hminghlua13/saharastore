...
function Cart() {
    ...
    const grandTotal = totalAmount < 50 ? totalAmount + 100 : totalAmount;
    ...
    const buyNow = async () => {
        ...
        var options = {
            key: "rzp_test_d1OhVOj8CtEImp",
            key_secret: "P3edJWqmGHfFFzMKi16RwiO5",
                    ...
                    <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '' }}>
                        ...
                        <div className="flex justify-between mb-3">
                            ...
                            <div className="text-lg font-bold">
                                <p className="mb-1" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{grandTotal}</p>
                            </div>
                        </div>
