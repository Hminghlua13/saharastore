    ...
    <div className="container mx-auto px-5 py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-lg text-gray-700 leading-relaxed mb-8">
          <p>
            Kanlo lawm a che.A hmasa in he page ilo tlawh ve avang hian kan lawm e.He website hi BCA VI Semester in Major Project a kan neih ani a,i mamawh leh i beisei ang taka ilo hmanve theih ngei kan beisei in kan duhpui che ani.
          </p>
          <p>
          ...
          <p>
          <strong>THLAMUANG TAK LEH HIM TAKA ILO BAZAR VE NGEI THEIH NAN DUHSAKNA KAN HLAN A CHE</strong>
          </p>
        </div>
      </div>
    </div>
