...
function AllProducts() {
  ...
  const addToCartHandler = (product) => {
    ...
    // You may handle notifications or toasts here
  };
                      ...
                      >
                        ...
                        <div className="p-5 border-t-2">
                          ...
                          <div className="flex justify-center">
                            <button type="button" onClick={() => addToCartHandler(item)} className="focus:outline-none text-white bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm w-full py-2">
                              Add To Cart
                            </button>
                          </div>
                        </div>
