...
function Navbar() {
  ...
  AllProducts
                  ...
                  {user?.user?.email === 'tluangahruai740@gmail.com' ? <div className='flow-root'>
            ...
            <div className='flex h-16 items-center'>
              ...
              <div className='ml-4 flex lg:ml-0'>
                <Link to={'/'} className='flex'>
                  <div className='flex'>
                    <h1 className='text-2xl font-bold text-black px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '' }}>SAHARA</h1>
                  </div>
                </Link>
              </div>
  ...
  AllProducts
                  ...
                  {user?.user?.email === 'tluangahruai740@gmail.com' ? <Link to={'/dashboard'} className='text-sm font-medium text-gray-700' style={{ color: mode === 'dark' ? 'white' : '' }}>
                    Admin
                  </Link> : ''}
                ...
                <div className='hidden lg:ml-8 lg:flex'>
                  <a href='#' className='flex items-center text-gray-700'>
                    <img
                      className='inline-block w-10 h-10 rounded-full'
                      src='https://www.bing.com/th?id=OIP.ysgtt4r2-5Xhu74oGuj77QHaEc&w=211&h=150&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2'
                      alt='Dan_Abromov' />
                  </a>
                </div>
